...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], e)
    : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).easytimer = {}));
})(this, function (t) {
  "use strict";
  function e(t, e) {
    var n = Object.keys(t);
  ...
  function O() {
    ...
    function $(t) {
      (e = tt((t = t || {}).precision)),
        ...
        (E = K()),
        Q(),
        "object" === r(t.target) ? (T = ot(t.target)) : A ? ((t.target = {seconds: 0}), (T = ot(t.target))) : (T = null),
        (U = {precision: e, callback: s, countdown: "object" === r(t) && !0 === t.countdown, target: T, startValues: j}),
        (O = t);
    }
    function tt(t) {
